...
<body>
	...
	<form action="<%=ORSView.MARKSHEET_LIST_CTL%>" method="POST">
		...
		<center>
			...
			<table width="100%" align="center">
				<tr>
                    ...
                    --%> <%=HTMLUtility.getList("rollNo123", String.valueOf(bean.getRollNo()), l)%>
						&nbsp; <lable> Result : </font></lable> <input type="text" name="result"
                    ...
                    HashMap map = new HashMap();
                     ...
                     String htmlList = HTMLUtility.getList("result", bean.getResult(), map);
                     %>
                     <%=htmlList %> --%> <input type="submit"
			...
			<table border="1" width="100%" align="center" cellpadding=6px
				...
				<%
					String res = DataUtility.getString(request.getParameter("result"));
						...
						if (res != null && res.length() > 0) {
							...
							while (itr.hasNext()) {
								...
								if (phy >= 33 && chem >= 33 && math >= 33 && res.equalsIgnoreCase("pass")) {
				%>
				<tr align="center">
 ...
 %>
				...
				<%
					} else if ((phy <= 33 || chem <= 33 || math <= 33) && res.equalsIgnoreCase("fail")) {
				%>
				<tr align="center">
					<td><input type="checkbox" class="checkbox" name="ids"
						value="<%=bean.getId()%>"></td>
